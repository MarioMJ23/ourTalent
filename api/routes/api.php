...
Route::middleware(['auth:api', 'estatus'])->group(function () {
	...
	Route::resource(	'tipos_de_actividad',	'TiposActividadController',
											[	'only'	=>	[	'index',	'show',  'store',	'update',	'destroy']]);
	...
	Route::resource(	'tipos_de_archivos',	'TiposArchivoController',
											[	'only'	=>	[	'index',	'show',  'store',	'update',	'destroy']]);
	...
	Route::resource(	'tipos_de_institucion',	'TiposInstitucionController',
											[	'only'	=>	[	'index',	'show',  'store',	'update',	'destroy']]);
	...
	Route::resource(	'tipos_de_sangre',	'TiposSangreController',
											[	'only'	=>	[	'index',	'show',  'store',	'update',	'destroy']]);
	...
	Route::resource(	'tipos_de_usuario',	'TiposUsuarioController',
											[	'only'	=>	[	'index',	'show',  'store',	'update',	'destroy']]);
});
