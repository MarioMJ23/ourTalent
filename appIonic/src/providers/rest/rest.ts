...
//    this.apiClient_secret = "ro0tTXWfp6TWGtUzW9al6ZI1qOPwEmoF0M7yxRSY";
  ...
  miMenu(): Observable<String[]>  {
    ...
    return this.http.get( serviceUrl).map(  this.extraertData, headersService).catch(  this.delegarError);
  };
  ...
  loginUsuario(  data): Observable<Object[]> {
    ...
    let headerObject  = new HttpHeaders().set(  'Content-Type', 'application/json');
    let headersService  =  {  headers:  headerObject};
    return  this.http.post( serviceUrl, params, headersService).map(  this.extraertData).catch(  this.delegarError);
  };
  ...
  actividades(): Observable<Object[]>  {
    ...
    let headersService  =  {  headers:  headerObject};
    return  this.http.get(  serviceUrl, headersService).map(  this.extraertData).catch(  this.delegarError);
  };
